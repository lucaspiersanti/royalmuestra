...
const Promo10 = (
	...
	const titulo = 'Promoción Exclusiva 10% de descuento';
	...
	pdf.setFontSize(26);
	pdf.setTextColor(0, 0, 0);
	pdf.text(`USD ${formatearPrecios(plan100.precioLista * 0.7)}`, 25, 245);
	pdf.line(25, 250, 215, 250, 'S');
	pdf.setFontSize(12);
	pdf.setTextColor('RED');
	pdf.text(`30% de descuento`, 25, 260);
	...
	pdf.setFontSize(26);
	pdf.setTextColor(0, 0, 0);
	pdf.text(`USD ${formatearPrecios(plan80.precioLista * 0.8)}`, 235, 245);
	pdf.line(235, 250, 425, 250, 'S');
	pdf.setFontSize(12);
	pdf.setTextColor('RED');
	pdf.text(`20% de descuento`, 235, 260);
	pdf.setTextColor('#90979f');
	...
	pdf.setFontSize(26);
	pdf.setTextColor(0, 0, 0);
	pdf.text(`USD ${formatearPrecios(plan60.precioLista * 0.85)}`, 25, 395);
	pdf.line(25, 400, 125, 400, 'S');
	pdf.setFontSize(12);
	pdf.setTextColor('RED');
	pdf.text(`15% de descuento`, 25, 410);
	pdf.setTextColor('#90979f');
	...
	pdf.setFontSize(26);
	pdf.setTextColor(0, 0, 0);
	pdf.text(`USD ${formatearPrecios(plan40.precioLista * 0.88)}`, 165, 395);
	pdf.line(165, 400, 275, 400, 'S');
	pdf.setFontSize(12);
	pdf.setTextColor('RED');
	pdf.text(`12% de descuento`, 165, 410);
	pdf.setTextColor('#90979f');
	...
	pdf.setFontSize(26);
	pdf.setTextColor(0, 0, 0);
	pdf.text(`USD ${formatearPrecios(plan30.precioLista * 0.9)}`, 305, 395);
	pdf.line(305, 400, 415, 400, 'S');
	pdf.setFontSize(12);
	pdf.setTextColor('RED');
	pdf.text(`10% de descuento`, 305, 410);
	pdf.setTextColor('#90979f');
	...
	const datosTabla30 = [
		...
		[
			`USD ${formatearPrecios(plan30.precioLista * 0.9)}`,
			`USD ${formatearPrecios(plan30.precioLista * 0.9 * 0.3)}`,
			`USD ${formatearPrecios(
				plan30.precioLista * 0.9 - plan30.precioLista * 0.9 * 0.3,
			)}`,
			`USD ${formatearPrecios(
				(plan30.precioLista * 0.9 - plan30.precioLista * 0.9 * 0.3) / 24,
			)}`,
			`USD ${formatearPrecios(
				((plan30.precioLista * 0.9 - plan30.precioLista * 0.9 * 0.3) / 36) *
					1.15,
			)}`,
			`USD ${formatearPrecios(
				((plan30.precioLista * 0.9 - plan30.precioLista * 0.9 * 0.3) / 48) *
					1.3,
			)}`,
		],
	];
	...
	const datosTabla40 = [
		...
		[
			`USD ${formatearPrecios(plan40.precioLista * 0.88)}`,
			`USD ${formatearPrecios(plan40.precioLista * 0.88 * 0.4)}`,
			`USD ${formatearPrecios(
				plan40.precioLista * 0.88 - plan40.precioLista * 0.88 * 0.4,
			)}`,
			`USD ${formatearPrecios(
				(plan40.precioLista * 0.88 - plan40.precioLista * 0.88 * 0.4) / 24,
			)}`,
			`USD ${formatearPrecios(
				((plan40.precioLista * 0.88 - plan40.precioLista * 0.88 * 0.4) / 36) *
					1.15,
			)}`,
			`USD ${formatearPrecios(
				((plan40.precioLista * 0.88 - plan40.precioLista * 0.88 * 0.4) / 48) *
					1.3,
			)}`,
		],
	];
	...
	const datosTabla60 = [
		...
		[
			`USD ${formatearPrecios(plan60.precioLista * 0.85)}`,
			`USD ${formatearPrecios(plan60.precioLista * 0.85 * 0.6)}`,
			`USD ${formatearPrecios(
				plan60.precioLista * 0.85 - plan60.precioLista * 0.85 * 0.6,
			)}`,
			`USD ${formatearPrecios(
				(plan60.precioLista * 0.85 - plan60.precioLista * 0.85 * 0.6) / 24,
			)}`,
			`USD ${formatearPrecios(
				((plan60.precioLista * 0.85 - plan60.precioLista * 0.85 * 0.6) / 36) *
					1.15,
			)}`,
			`USD ${formatearPrecios(
				((plan60.precioLista * 0.85 - plan60.precioLista * 0.85 * 0.6) / 48) *
					1.3,
			)}`,
		],
	];
	...
	const datosTabla80 = [
		...
		[
			`USD ${formatearPrecios(plan80.precioLista * 0.8)}`,
			`USD ${formatearPrecios(
				plan80.precioLista * 0.8 - plan80.precioLista * 0.8 * 0.2,
			)}`,
			`USD ${formatearPrecios(plan80.precioLista * 0.8 * 0.2)}`,
			`USD ${formatearPrecios((plan80.precioLista * 0.8 * 0.2) / 24)}`,
			`USD ${formatearPrecios(((plan80.precioLista * 0.8 * 0.2) / 36) * 1.15)}`,
			`USD ${formatearPrecios(((plan80.precioLista * 0.8 * 0.2) / 48) * 1.3)}`,
		],
	];
	...
	pdf.save(
		`Royale Village - PROMOCIÓN 10% EXTRA - lote ${formattedNroLote} - ${formattedDate} - ${formCliente.apellido}`,
	);
};

export default Promo10;
