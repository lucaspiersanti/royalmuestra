export const SeleccionPlanes2 = ({ onPlanSeleccionado }) => {

  const devolverPlanSeleccionado = (_plan) => {
    switch (_plan) {
      case "0":
        onPlanSeleccionado(0, false); //CrowdLending
        break;
      case "1":
        onPlanSeleccionado(1, true);//Crowdfunding
        break;
      default:
        ...
        <div className="flex flex-wrap -m-4">
          <div style={{ cursor: 'pointer' }} onClick={() => devolverPlanSeleccionado("0") } className="p-4 lg:w-1/2 md:w-full ">
            <div className="flex border-2 rounded-lg border-gray-200 border-opacity-50 hover:border-yellow-500 p-8 sm:flex-row flex-col">
              ...
              <div className="flex-grow">
                <h2 className="text-gray-900 text-lg title-font font-medium mb-3">CrowdLending</h2>
                <p className="leading-relaxed text-base" >Podrás consultar por los metros cuadrados que creas conveniente.</p>
              </div>
            </div>
          </div>
          <div style={{ cursor: 'pointer' }} onClick={() => devolverPlanSeleccionado("1") } className="p-4 lg:w-1/2 md:w-full">
            <div className="flex border-2 rounded-lg hover:border-yellow-500 border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col">
              ...
              <div className="flex-grow">
                <h2 className="text-gray-900 text-lg title-font font-medium mb-3">Crowdfunding</h2>
                <p className="leading-relaxed text-base" >Consultá por el precio de los terrenos, en secciones establecidas.</p>
              </div>
            </div>
          </div>
        </div>
